...
public interface UserService {
    ...
    // Get a list of users with pagination support
     ResponseEntity<ApiResponse<UsersResponseDTO>> getUsers(Pageable pageable);
    ...
    // Update a user with the provided ID and UpdateUserDTO, and return the response
     ResponseEntity<ApiResponse<UserResponseDTO>> updateUser(String userId, UpdateUserDTO updateUserDTO);

    // Delete a user with the provided ID and return the response
     ResponseEntity<ApiResponse<Object>> deleteUser(String userId);
